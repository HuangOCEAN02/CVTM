...
% new
clear;
name2 = './CV/ASA_IMP_1PNESA20091120_113512_000000182084_00252_40386_0000_Orb_Cal_Spk_Spk_TC.nc';
title_name ='ASA-IMP-1P 20-Nov-2009 11:35:13 UTC';
ncdisp(name2);
...
img=getframe(gcf);
imwrite(img.cdata,['CV_20_Nov_2009.tiff'], 'tiff', 'Resolution', 300)
