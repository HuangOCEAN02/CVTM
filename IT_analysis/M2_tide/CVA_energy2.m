...
% APE_h = APE_h.*1e-3.*depto_grid;% kJ/m^2
% HKE_h = HKE_h.*1e-3.*depto_grid;% kJ/m^2

APE_h = APE_h.*1e-3; % kJ/m^3
HKE_h = HKE_h.*1e-3; % kJ/m^3
...
set(barh(1),'Facecolor',[0.3,0.65,0.75],'Linewidth',1.5,'DisplayName','$|<\overline{HKE}>|$');
set(barh(2),'Facecolor',[0.89,0.45,0.23],'Linewidth',1.5,'DisplayName','$|<\overline{APE}>|$');
set(barh,'Linewidth',1.5,'Barwidth',1);
xlim([30 2000])
set(gca,'fontsize',25,'fontname','Arial','XTick',[0:200:3600]);
% set(gca,'XScale','log')
set(gca,'xlim',[0 3500],'XTick',[0:200:3600],'fontname','Arial','fontweight','bold','YColor','k');
...
% img=getframe(gcf);
% imwrite(img.cdata,['BC_M2_energy_topo2.tiff'], 'tiff', 'Resolution', 300)
% 
