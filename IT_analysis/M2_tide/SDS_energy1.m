...
set(barh(1),'Facecolor',[0.00,0.79,0.25],'Linewidth',1.5);
set(barh(2),'Facecolor',[0.30,0.75,0.93],'Linewidth',1.5);
set(barh(3),'Facecolor',[0.91,0.91,0.14],'Linewidth',1.5);
...
set(gca,'YColor','k')
% leg = legend('Conversion','Radiation','Dissipation');
% set(leg,'Orientation','vertical','Location','northeast',...
%     'EdgeColor','k',...
%     'Color','w','fontsize',15)
...
set(gca,'ylim',[-80 80],'YTick',[-80:40:80],'fontname','Arial','fontweight','bold');
ylabel([' Cumulation  \newline ' ...
    ' $(MW)$'],'Interpreter','latex','Rotation',90,'FontSize',28,'FontWeight','bold','fontname','Arial')
set(gca,'YColor','k')
...
img=getframe(gcf);
imwrite(img.cdata,['BC_M2_energy_SDS_topo1.tiff'], 'tiff', 'Resolution', 300)
